...
const sizeConfig = {
  ...
  sm: {
    width: 'w-16 sm:w-24 h-24 sm:h-36',
    innerMargin: 'inset-[3px] sm:inset-1',
    cornerOffset: 'top-1 left-1 sm:top-1.5 sm:left-1.5',
    cornerOffsetRight: 'bottom-1 right-1 sm:bottom-1.5 sm:right-1.5',
    cornerText: 'text-[9px] sm:text-sm font-black',
    cornerSubtitle: 'text-[4px] sm:text-[6px]',
    centerText: 'text-sm sm:text-2xl',
    iconSize: 'w-2 h-2 sm:w-3 h-3',
    badgeText: 'text-[5px] sm:text-[7px]',
    badgeSub: 'text-[4px] sm:text-[6px]',
    badgeBottom: 'bottom-1.5 sm:bottom-3',
  },
  md: {
    width: 'w-32 h-44',
  ...
  hand: {
    width: 'w-22 sm:w-26 h-32 sm:h-38',
    innerMargin: 'inset-1 sm:inset-1.5',
    cornerOffset: 'top-1.5 left-1.5 sm:top-2 sm:left-2',
    cornerOffsetRight: 'bottom-1.5 right-1.5 sm:bottom-2 sm:right-2',
    cornerText: 'text-sm sm:text-base font-black',
    cornerSubtitle: 'text-[6px] sm:text-[7px]',
    centerText: 'text-2xl sm:text-3xl',
    iconSize: 'w-3 h-3 sm:w-3.5 h-3.5',
    badgeText: 'text-[7px] sm:text-[8px]',
    badgeSub: 'text-[5px] sm:text-[6px]',
    badgeBottom: 'bottom-3 sm:bottom-4',
  }
};
